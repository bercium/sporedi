...
class CombinedNatgeoClass extends GeneralParser{
    ...
    protected function combined_schedule($channel, $date){
        $htmlData = $this->getHtml("http://www.natgeotv.com/si/event/".$channel."/".str_replace("-", "", $date)."/".str_replace("-", "", $date));
        ...
        while(strpos($htmlData, '<li') !== false){
            ...
            if ($channel == '78') $singleData->genre = 'naravoslovje';
